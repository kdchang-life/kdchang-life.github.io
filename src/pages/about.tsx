        ...
        <section className={styles.section}>
          ...
          <div className={styles.bioText}>
            ...
            <p>
              ...
              人工智慧新創獨角獸公司和全球前三大瀏覽器製造外商，也曾參與數個新創組織的創辦和嘗試過多個網路產品服務的開發和擔任{" "}
              <a
                href="https://youth.taichung.gov.tw/CommitteeManage/Detail/4cec65cc-626b-4d42-a970-b2d09ba45727"
                target="_blank"
                rel="noopener noreferrer"
              >
                台中市政府青年諮詢委員
              </a>
              ，累積了豐富的軟體開發、產品管理、專案管理和團隊領導經驗。是一個熱愛獨立開發和打造人們喜愛的產品的
              Builder、Indie Hacker & Solo Developer。
            </p>
            <p>
              同時也是{" "}
              <a
